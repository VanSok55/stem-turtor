          ...
          {books.map((book, index) => (
            ...
            >
              <div className="border bg-white text-gray-700 shadow-md rounded-lg">
                ...
                <div className="p-3">
                  <h4 className="line-clamp-1 text-[18px] -mt-12 md:text-[18px] lg:text-[19px] block font-suwannaphum xl:text-xl xl:mt-4 font-semibold leading-snug tracking-normal text-blue-gray-900">
                    {book.title}
                  </h4>
                  <span className="line-clamp-2 mt-2 text-[15px] xl:h-[50px] xl:mb-7 block mb-5 font-suwannaphum xl:text-lg antialiased font-normal leading-relaxed text-gray-900">
                    {book.description}
                  </span>
                </div>
